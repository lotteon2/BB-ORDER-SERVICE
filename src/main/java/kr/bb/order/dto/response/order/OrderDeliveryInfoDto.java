...
public class OrderDeliveryInfoDto {
    ...
    public static OrderDeliveryInfoDto toDto(String orderDeliveryId, List<OrderDelivery> orderDeliveries, List<OrderDeliveryProduct> orderDeliveryProducts, List<OrderDeliveryDetailsDto> orderDeliveryDetailDtos){
        ...
        List<Long> orderProductIds = orderDeliveryProducts.stream().map(OrderDeliveryProduct::getOrderProductId).collect(Collectors.toList());
